...
parking_spots = {
    ...
    3: [[91, 151], [91, 0], [179, 0], [180, 152]],
    4: [[0, 150], [0, 0], [91, 0], [91, 151]],
    5: [[360, 350], [361, 490], [454, 490], [451, 380]],
    6: [[271, 350], [274, 490], [361, 490], [360, 380]],
    7: [[180, 350], [182, 490], [274, 490], [271, 380]],
    8: [[92, 350], [92, 490], [182, 490], [180, 380]],
    9: [[0, 350], [0, 490], [92, 490], [92, 380]]
}
...
class EKF:
    ...
    def apply(self, pose):
        ...
        obs_forward_velocities = np.linalg.norm(
            pose[:2] - self.pose_last[:2]) / dt
        ...
        self.pose_last = np.array(
            [self.mu_x[-1], self.mu_y[-1], self.mu_theta[-1]])
        self.times.append(t)
